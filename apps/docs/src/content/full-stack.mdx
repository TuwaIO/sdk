...
Import the bundled Nova UI CSS stylesheet in your root layout:
...
## 🌉 6. Quasar Auth Bridge (`QuasarSDKAuthProvider.tsx`)
...
Render **`<ConnectButton />`**, **`<TxActionButton />`**, and **`<TransactionList />`** anywhere in your application:
...
import { TransactionList, TxActionButton } from '@tuwaio/sdk/nova-transactions';
...
- 🌐 **[Ecosystem Central Hub](https://docs.tuwa.io/)**
- 💫 **[Orbit Utils Docs](https://orbit.docs.tuwa.io/)**
- 📡 **[Satellite Connect Docs](https://satellite.docs.tuwa.io/)**
- ⚡ **[Pulsar Engine Docs](https://pulsar.docs.tuwa.io/)**
- 🎨 **[Nova UI Storybook](https://stories.tuwa.io/)**
