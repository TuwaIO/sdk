...
3. **Stateless Multi-Chain Verification**: Supports both EVM (`viem`) and Solana (`@solana/kit` / SubtleCrypto) verification out of the box with zero database lookups on your server.
