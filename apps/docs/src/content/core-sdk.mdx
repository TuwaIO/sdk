...
`@tuwaio/sdk` is **Layer 8 (L8)** of the TUWA ecosystem — the unified client UI and Logic foundation. It packages Orbit (primitives), Pulsar (transaction tracking), Satellite (wallet connections), SIWX (CAIP-122 auth), and Nova (React UI components) into clean, tree-shakeable subpaths.
...
| **Satellite Connect**  | `@tuwaio/sdk/satellite`    | 📡 **[Satellite Connect Docs](https://satellite.docs.tuwa.io/)** — Headless wallet state machine.     |
...
| **SIWX Auth**          | `@tuwaio/sdk/siwx`         | 🔐 **[SIWX Docs](https://siwx.docs.tuwa.io/)** — Headless CAIP-122 multi-chain authentication.                    |
...
// 6. CAIP-122 Authentication (SIWX)
import { useSiwx, useSiwxSession } from '@tuwaio/sdk/siwx';
```

_Note: `@tuwaio/sdk` exports the full API surface of Satellite, Pulsar, Orbit, Nova, and SIWX. Refer to the respective documentation links above for complete API signatures._
