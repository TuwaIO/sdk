...
|     Wagmi/Viem + EVMConnectorsWatcher|     Solana Kit/Wallet Standard + SolanaWatcher    |
+------------------------------------+----------------------------------------------+
```
...
1. **L1 – L2: Foundation Primitives (Orbit & SIWX)**
   ...
   - **L2 Platforms & Adapters (`@tuwaio/orbit-evm`, `@tuwaio/orbit-solana`, `@tuwaio/siwx-*`)**: Chain-specific client creators and framework bindings (Viem, Wagmi, Solana Kit, React).
